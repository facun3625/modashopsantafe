import { TagIcon, TruckIcon, StoreIcon, StarIcon } from "@/components/icons";

type Benefit = { icon: React.ComponentType<React.SVGProps<SVGSVGElement>>; title: string; subtitle: string };

// Franja de 4 beneficios debajo del hero — los textos que dependen de datos
...
export function BenefitsStrip({
  ...
  const benefits: Benefit[] = [
    ...
    { icon: StarIcon, title: "Nuevos ingresos", subtitle: "Descubrí lo último" },
  ];

  return (
    <div className="mt-3 grid grid-cols-2 gap-3 rounded-3xl bg-brand-soft px-4 py-5 sm:grid-cols-4 sm:px-6">
      {benefits.map((b, i) => (
