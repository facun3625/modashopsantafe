          ...
          {categories.map((cat) => (
            ...
            >
              <div className="relative overflow-hidden rounded-xl">
                ...
                <div className="absolute inset-x-2.5 bottom-2.5 flex items-center justify-between gap-2 rounded-full bg-white py-2 pl-4 pr-2 shadow-md transition-colors group-hover:bg-brand-pink">
