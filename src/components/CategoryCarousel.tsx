            ...
            >
              <div className="relative overflow-hidden rounded-xl">
                ...
                <div className="absolute inset-x-2.5 bottom-2.5 flex items-center justify-between gap-2 rounded-full bg-white py-2 pl-4 pr-2 shadow-md">
                  ...
                  <span className="flex h-7 w-7 shrink-0 items-center justify-center rounded-full bg-white text-brand-pink-dark shadow-sm transition-colors hover:bg-brand-pink hover:text-white">
